function [mappedX, mapping, Sb, Sw, St] = lda(X, labels, no_dims)
%LDA Perform the LDA algorithm
%
%   [mappedX, mapping] = lda(X, labels, no_dims)
%
% The function runs LDA on a set of datapoints X. 
% The variable no_dims sets the number of dimensions of the feature points 
% in the embedded feature space (no_dims >= 1, default = 2). The maximum number 
