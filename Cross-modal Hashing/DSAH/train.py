...
class Session:
    def __init__(self):
        ...
        self.train_dataset = MY_DATASET(path=settings.DIR)
        self.test_dataset = MY_DATASET(path=settings.DIR, train=False, database=False)
        self.database_dataset = MY_DATASET(path=settings.DIR, train=False, database=True)
