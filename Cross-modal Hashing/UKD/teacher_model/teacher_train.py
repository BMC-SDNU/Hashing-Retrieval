...
WORKDIR = '/cache/'
# DIS_MODEL_BEST_FILE = '/home/WangBoWen/HashingRetrieval/pythonProject/UKD/data/mir_dis_teacher/flickr_dis_teacher_best_' + str(OUTPUT_DIM) + '.model'
# DIS_MODEL_NEWEST_FILE = '/home/WangBoWen/HashingRetrieval/pythonProject/UKD/data/mir_dis_teacher/flickr_dis_teacher_newset_' + str(OUTPUT_DIM) + '.model'

DIS_MODEL_BEST_FILE = '/home/WangBoWen/HashingRetrieval/pythonProject/UKD/data/teacher_test/flickr_dis_teacher_best_' + str(OUTPUT_DIM) + '.model'
DIS_MODEL_NEWEST_FILE = '/home/WangBoWen/HashingRetrieval/pythonProject/UKD/data/teacher_test/flickr_dis_teacher_newset_' + str(OUTPUT_DIM) + '.model'


DIS_MODEL_PRETRAIN_FILE = '/home/WangBoWen/HashingRetrieval/pythonProject/UKD/data/teacher_best_pretrain_' + str(OUTPUT_DIM) + '.model'
...
train_i2t = np.load(path+'train_i2t.npy', allow_pickle=True).item()
train_i2t_pos = np.load(path+'train_i2t_pos.npy', allow_pickle=True).item()
train_i2t_neg = np.load(path+'train_i2t_neg.npy', allow_pickle=True).item()
train_t2i = np.load(path+'train_t2i.npy', allow_pickle=True).item()
train_t2i_pos = np.load(path+'train_t2i_pos.npy', allow_pickle=True).item()
train_t2i_neg = np.load(path+'train_t2i_neg.npy', allow_pickle=True).item()
...
test_t2i_pos = np.load(path+'test_t2i_pos.npy', allow_pickle=True).item()

feature_dict = np.load(path+'mir_data_feature_dict.npy', allow_pickle=True).item()
label_dict = np.load(path+'mir_data_label_dict.npy', allow_pickle=True).item()

item_num = len(feature_dict)
...
def main():
    with tf.device('/gpu:' + str(GPU_ID)):
        dis_param = pickle.load(open(DIS_MODEL_PRETRAIN_FILE, 'rb'))  # 加载预训练模型参数，可以不加载
