...
from load_data_my import load_dataset
import numpy as np
import pdb
import time
import logging
...
class Session:
    def __init__(self, opt):
        ...
        dataset, data_train = load_dataset(opt.data_name)
        # shuffle = {'query': False, 'train': True, 'database': False}

        # dataloader = {x: DataLoader(dataset[x], batch_size=opt.batch_size,
