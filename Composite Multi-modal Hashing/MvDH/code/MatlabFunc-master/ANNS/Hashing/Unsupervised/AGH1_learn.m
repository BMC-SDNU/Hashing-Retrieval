function [model, B, elapse] = AGH1_learn(A, maxbits, Anchor,s)
%   This is a function of One Layer AGH (Anchor Graph Hashing) learning.
%
%	Usage:
%	[model, B,elapse] = AGH1_learn(A, maxbits, Anchor,s)
%
...
[B, W, sigma] = OneLayerAGH_Train(A, Anchor, maxbits, s, 0, options);
