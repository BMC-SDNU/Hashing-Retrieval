...
c_num=2000; %%% this parameter is for the number of pseduo pair-wise labels
...
[eigvector, eigvalue] = PCA(covdata, options);
...
for i_bit=2:nbits
    ...
    [eigvector, eigvalue] = PCA(covdata+USPLHparam.eta*constraint_cov, options);
